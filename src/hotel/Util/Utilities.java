...
public class Utilities {
	...
	private static String calcDigVerif(String num) {
		...
		int soma = 0, peso = 10;
		soma = getSoma(num, soma, peso);

		primDig = getInteger(soma);
		...
		segDig = getInteger(soma);

		return primDig.toString() + segDig.toString();
	}

	private static Integer getInteger(int soma) {
		Integer primDig;
	...
	private static int getSoma(String num, int soma, int peso) {
